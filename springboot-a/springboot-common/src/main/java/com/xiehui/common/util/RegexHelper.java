/**
 * $Id$ Copyright 2013 Sparta. All rights reserved.
 */
...
public class RegexHelper {
    ...
    private static final String PHONE_PATTERN_STRING =
    ...
    private static final String MONEY_PATTERN_STRING = "^(([1-9]{1}\\d*)|([0]{1}))(\\.(\\d){0,2})?$";
    ...
    private static final Pattern MONEY_PATTERN = Pattern.compile(MONEY_PATTERN_STRING);
    ...
    public static boolean isRepeatChar(String str, float rate) {
        ...
        return 1.0 * RegexHelper.removeRepeatCharCount(str) / len < rate;
    }
